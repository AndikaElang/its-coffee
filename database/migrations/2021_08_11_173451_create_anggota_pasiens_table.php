...
class CreateAnggotaPasiensTable extends Migration
{
    ...
    public function up()
    {
        if (!Schema::connection($this->connection)->hasTable('anggota_pasien')) {
            Schema::connection($this->connection)->create('anggota_pasien', function (Blueprint $table) {
                $table->bigIncrements('id');
                $table->bigInteger('id_master_pasien')->unsigned()->nullable();
    ...
    {
        Schema::connection($this->connection)->dropIfExists('anggota_pasien');
    }
}
