...
class CreateHistoryRegistrasisTable extends Migration
{
    ...
    public function up()
    {
        if (!Schema::connection($this->connection)->hasTable('history_registrasi')) {
            Schema::connection($this->connection)->create('history_registrasi', function (Blueprint $table) {
    ...
    {
        Schema::connection($this->connection)->dropIfExists('history_registrasi');
    }
}
