...
return new class extends Migration {
  ...
  public function up(): void
  {
    ...
    if (!Schema::connection($this->connection)->hasTable($tableNames['permissions'])) {
    ...
    if (!Schema::connection($this->connection)->hasTable($tableNames['roles'])) {
    ...
    if (!Schema::connection($this->connection)->hasTable($tableNames['model_has_permissions'])) {
    ...
    if (!Schema::connection($this->connection)->hasTable($tableNames['model_has_roles'])) {
    ...
    if (!Schema::connection($this->connection)->hasTable($tableNames['role_has_permissions'])) {
